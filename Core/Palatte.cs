...
{
    public class Palatte        // these colors are put seperatly from the other colors cause theres are for the range of possible colors to use
    {                          // but the colors in Colors.cs are for specific use cases 
        ...
        public static RLColor DbLightText = new RLColor(222, 238, 214);
        public static RLColor DbLight = new RLColor(255, 255, 255);
        public static RLColor OpC = new RLColor(19,93,216);
        public static RLColor FeinC = new RLColor(255,255,0);
        public static RLColor MercenaryPalatte = new RLColor(128,0,0);
    }
}
