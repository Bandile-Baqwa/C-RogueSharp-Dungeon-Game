...
namespace RLNETConsoleGame.Core
{
    public class DungeonMap : Map    // this map that  was inherited from  using RogueSharp 
    {
        ...
        public void PickUpTreasure(Actor actor, int x, int y)
        {
        ...
        public bool IsPlayerOnTreasure(Actor player, int x, int y)
        {
        ...
        public System.Drawing.Point GetRandomLocation()
        {
        ...
        public System.Drawing.Point GetRandomLocationInRoom(Rectangle room)
        {
            int x = Game.Random.Next(1, room.Width - 2) + room.X;
            int y = Game.Random.Next(1, room.Height - 2) + room.Y;
            if (!IsWalkable(x, y))
            {
               return GetRandomLocationInRoom(room);
            }
        ...
        public void Draw(RLConsole mapConsole, RLConsole statConsole,RLConsole inventoryConsole)
        {
            ...
            player.DrawInvemtory(inventoryConsole);
