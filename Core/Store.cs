...
namespace RLNETConsoleGame.Core
{
    public class Store
    {
        //public List<Item> storeItems; // List of items available in the store
        ...
        //public bool BuyItem(PlayerInventory playerInventory, string itemName)       // just go over the other signatures and make sure that htye correspond wiht these signatures 
        //{
