    ...
    public class TargetingSystem
    {
        ...
        public void Draw(RLConsole mapConsole)
        {
            if (IsPlayerTargeting)
            {
                ...
                {
                    foreach (Cell cell in map.GetCellsInCircle(_cursorPosition.X, _cursorPosition.Y, _area))
                    {
                        mapConsole.SetBackColor(cell.X, cell.Y, Palatte.DbSun);
                    }
                }
                else if (_selectionType == SelectionType.Line)
                {
                ...
                mapConsole.SetBackColor(_cursorPosition.X, _cursorPosition.Y, Palatte.DbLight);
            }
        }
    }
}
